...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout llCategoryContainer;

  @NonNull
  public final TextView tvCategoryName;

  private ItemCategoryBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout flIconBg,
      @NonNull ImageView ivCategoryIcon, @NonNull ConstraintLayout llCategoryContainer,
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout llCategoryContainer = (ConstraintLayout) rootView;
      ...
      return new ItemCategoryBinding((ConstraintLayout) rootView, flIconBg, ivCategoryIcon,
          llCategoryContainer, tvCategoryName);
    }
